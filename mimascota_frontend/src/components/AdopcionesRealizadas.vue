    ...
    <div class="adopciones-recibidas">
        ...
        <div class="content-wrapper">
            ...
            <div v-else-if="solicitudes.length === 0" class="empty-state">
                <h2 class="no-results-title">¡Vaya! No tienes solicitudes de adopción realizadas todavía.</h2>
                ...
                <table class="solicitudes-table">
                    ...
                    <tbody>
                        <tr v-for="(solicitud, index) in solicitudes" :key="solicitud.idxxxx_forado">
                            ...
                            <td>
                                <span :class="['status-badge', getStatusClass(solicitud.estado_adopcion)]">
                                    {{ solicitud.estado_adopcion }}
                                </span>
                            </td>
                        </tr>
                    </tbody>
...
const fetchUserSolicitudes = async () => {
    ...
    try {
        ...
        const response = await fetch('http://localhost:3000/api/adoptions/userSuccessAdoption', {
            headers: {
