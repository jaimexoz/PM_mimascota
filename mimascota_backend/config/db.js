...
const pool = new Pool({
  ...
  // Configuración SSL para entornos donde la base de datos requiere conexión segura (ej. Heroku Postgres, Render, Supabase)
  // En desarrollo local (localhost), esto a menudo puede ser omitido o configurado como rejectUnauthorized: false
  ssl: {
    rejectUnauthorized: false, // Establece a 'false' para permitir certificados autofirmados (común en servicios cloud)
  },
});
